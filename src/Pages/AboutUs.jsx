...
import Samskriti from "../assets/isha samskriti.jpeg"
function AboutUs() {
  return (
        ...
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-center text-slate-500">
          <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
            <div className="my-24 flex lg:w-[50%] flex-col gap-6">
              <h1 className="bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045] bg-clip-text text-4xl font-semibold text-transparent lg:w-[70%] p-3 ">
                Our Founding Story
              </h1>
